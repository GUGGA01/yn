...
owner_id = 1221262658  # Replace with your Telegram user ID
...
async def attack(update: Update, context: CallbackContext):
    ...
    def run_attack():
        ...
        try:
            ...
            full_command = f"./sun {target} {port} {attack_time} 1200"
...
def main():
    ...
    bot_token = "8016902517:AAEOMlWyeoLyPvJaa3b2AtVrljpNgbeU7KU"
